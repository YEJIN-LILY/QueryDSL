...
public class QuerydslBasicTest {
    ...
    public void result() {
        ...
        For example: in JPA count queries can’t be generated for queries that have multiple group by
        expressions or a having clause. Get the projection in QueryResults form.
    ...
    @Test
    public void findMemberDtoByQueryProjection() {
        List<MemberDto> result = queryFactory
